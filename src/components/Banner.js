  ...
  return (
    <div className="w-full relative h-[700px]">
      <div className="w-full h-full">
        <div className="w-full h-[700px] absolute g-gradient-to-t from-black to-transparent z-[20] bottom-0" />
        <img
        ...
        <div className="absolute font-Beue hidden lg:grid   w-full top-[30%] mb-3 p-4 md:p-8">
          ...
          <div className="flex py-2">
            {[...Array(5)].map((_, i) => <StarIcon key={i} className="h-4 w-4 fill-current text-red-600" />)}
          </div>
          ...
          <div className="my-4">
            <div className="text-red-600 animate-pulse flex space-x-12">
              ...
              <button className="text-white font-bold flex items-center bg-red-600 rounded-lg px-5 py-2" type="button"><AiOutlinePlayCircle size={25} /> play</button>
